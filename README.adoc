...
Fractor is a lightweight Ruby framework for parallel processing using Ractors. It provides a structured way to distribute computational work across multiple Ractors with minimal boilerplate.
...
* link:ROADMAP.md[Roadmap] - Planned enhancements and features
