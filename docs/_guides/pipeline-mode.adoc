...
This section describes the components and their detailed usage specifically for pipeline mode (batch processing). For continuous mode, see the link:continuous-mode.adoc[Continuous Mode] documentation.
