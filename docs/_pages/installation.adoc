...
Fractor requires Ruby 3.0 or later. It relies on Ractor, which is available in Ruby 3.0+.
...
If you encounter errors about Ractor not being available, ensure you're using Ruby 3.0 or later:
